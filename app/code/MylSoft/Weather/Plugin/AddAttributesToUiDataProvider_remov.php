<?php
namespace MylSoft\Weather\Plugin;

use MylSoft\Weather\Ui\DataProvider\Weather\ListingDataProvider as WeatherDataProvider;
...
class AddAttributesToUiDataProvider
{
     ...
     *
     * @param MylSoft\Weather\Ui\DataProvider\Weather\ListingDataProvider $subject
     ...
     */
    public function afterGetSearchResult(WeatherDataProvider $subject, SearchResult $result)
    {
        if ($result->isLoaded()) {
            return $result;
        }
